...
var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"4066d07dcc3e09fc95b26c5936e0a91cb4ceced2b9":"POST"} */ __turbopack_context__.s({
    "POST": (()=>POST)
});
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ POST(request) {
    ...
    if (doc) {
        return Response.json({
            success: 'false',
            error: 'true',
            message: 'Already exist this username choose different!',
            result: null
        });
    }
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(POST, "4066d07dcc3e09fc95b26c5936e0a91cb4ceced2b9", null);
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__733bfe83._.js.map